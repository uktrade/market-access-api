...
class GoodsManager(models.Manager):
    ...
    def get_queryset(self):
        return super(GoodsManager, self).get_queryset().filter(
            Q(category="GOODS") | Q(category="GOODSANDSERVICES")
        )
...
class ServicesManager(models.Manager):
    ...
    def get_queryset(self):
        return super(ServicesManager, self).get_queryset().filter(
            Q(category="SERVICES") | Q(category="GOODSANDSERVICES")
        )
