...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--emails', type=str, help='CSV list of user emails', required=True)
    ...
    def handle(self, *args, **options):
        ...
        newline = "\n"
        logging.info(f'Deactivated Users:{newline}{newline.join([email for email in user_email_list])}')
