...
from api.documents.test.my_entity_document.views import MyEntityDocumentViewSet
...
my_entity_document_download = MyEntityDocumentViewSet.as_view({"get": "download"})
