...
#                 f"""
#                 BEGIN
#                    IF NOT EXISTS (SELECT * FROM metadata_barriertag
#                                    WHERE title = {tag["title"]})
#                    BEGIN
#                        INSERT INTO metadata_barriertag (title, description, show_at_reporting)
#                        VALUES ({tag["title"]}, {tag["description"]}, {tag["show_at_reporting"]})
#                    END
#                 END
#                 """
#             )
