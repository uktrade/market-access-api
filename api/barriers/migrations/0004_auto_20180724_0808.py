...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('barriers', '0003_auto_20180719_1130'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='kind',
            field=models.CharField(choices=[('INITIATOR', 'Initiator'), ('CONTRIBUTOR', 'Contributor'), ('LEAD', 'Lead')], max_length=25),
        ),
        migrations.AlterField(
            model_name='barrierinstance',
            name='chance_of_success',
            field=models.CharField(choices=[('HIGHLY_LIKELY', 'Highly likely'), ('LIKELY', 'Likely'), ('UNLIKELY', 'Unlikely'), ('HIGHLY_UNLIKELY', 'Highly unlikely')], help_text='chance of success', max_length=25, null=True),
        ),
        migrations.AlterField(
