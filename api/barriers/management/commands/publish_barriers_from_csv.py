...
from api.metadata.constants import TRADING_BLOCS, BarrierStatus, PublicBarrierStatus
    ...
    with open(csv_file, "r") as file:
        ...
        for row in reader:
            ...
            public_barrier = PublicBarrier(
                ...
                caused_by_trading_bloc=metadata.get_caused_by_trading_bloc(
                    row["Location"]
                ),
            ...
            if (
                row["Location"]
                and not public_barrier.country
                and not public_barrier.trading_bloc
            ):
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "file", type=str, help="CSV file for importing public barriers"
        )
